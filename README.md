...
> **⚠️ Os datasets não estão neste repositório devido ao tamanho dos arquivos.**
> Acesse os dados na pasta pública do Google Drive:
>
> 📂 **[Acessar Base de Dados (Google Drive)](https://drive.google.com/drive/folders/10PPlb7j3cko8X72beWcTg2HQS1x6C3xC?usp=sharing)**
...
- ✅ **Entrega 3** (26/04): Implementação Parcial — EDA, pré-processamento e modelo base SARIMA
  - [`cd_projeto_aplicado_IV_entrega_3.ipynb`](cd_projeto_aplicado_IV_entrega_3.ipynb) — notebook executado
  - [`Projeto_Aplicado_IV_Entrega_3.pdf`](Projeto_Aplicado_IV_Entrega_3.pdf) — Documentação atualizada
...
> 📂 **Dados**: disponíveis no [Google Drive](https://drive.google.com/drive/folders/10PPlb7j3cko8X72beWcTg2HQS1x6C3xC?usp=sharing) (arquivos muito grandes para o GitHub).
